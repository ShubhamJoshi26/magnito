        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                <div class="flex items-center space-x-3 mb-6">
                    <a href="/">
                        <img src="{{ asset('assets/img/footer_logo.png') }}" alt="Logo" class="h-10 w-auto">
                    </a>
                </div>
                <p class="text-secondary-300 mb-6 leading-relaxed">Technology Partners Who Deliver Tomorrow, Today.
                    Building scalable solutions for growing businesses.</p>
                <div class="flex space-x-4">
                    <a href="javascript:void(0)"
                        class="w-10 h-10 bg-secondary-800 rounded-lg flex items-center justify-center hover:bg-primary transition-colors duration-fast"
                        aria-label="LinkedIn">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">Inventory
                            Management</a></li>
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">EdTech
                            Solutions</a></li>
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">E-commerce
                            Engine</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">About Us</a>
                    </li>
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">Portfolio</a>
                    </li>
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">Careers</a></li>
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">Blog</a></li>
                    <li><a href="javascript:void(0)"
                            class="text-secondary-300 hover:text-white transition-colors duration-fast">Contact</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="pt-8 border-t border-secondary-800">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                ...
                <div class="flex space-x-6 text-sm">
                    ...
                    <a href="javascript:void(0)"
                        class="text-secondary-400 hover:text-white transition-colors duration-fast">Terms of Service</a>
                    <a href="javascript:void(0)"
                        class="text-secondary-400 hover:text-white transition-colors duration-fast">Cookie Policy</a>
                </div>
            </div>
        </div>
    </div>
